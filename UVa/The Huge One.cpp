...
void fast() {
    string n; cin >> n;
    ll numbers,x; cin >> numbers; set<ll>s;
    while(numbers--) cin >> x, s.insert(x);
    ...
    for(auto m:s) {
        ...
        for(ll i=n.size()-1, exp{}; i>=0; i--,exp++) {
            ll dig = n[i]-'0';
            rem += (dig * (ll)big_pow2(10,exp,m));
            rem %= m;
        }
        if(rem) wonderful=false;
    }
    if(wonderful) cout << n << " - Wonderful.";
    else cout << n << " - Simple.";
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int main() { IOS
