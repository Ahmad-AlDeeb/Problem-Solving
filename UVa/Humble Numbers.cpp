...
void fast() {
    ...
    while(cin >> n) {
        ...
        if(n%10==1 && n%100!=11) cout << "The " << n << "st humble number is " << humble[n] << ".";
        else if(n%10==2 && n%100!=12) cout << "The " << n << "nd humble number is " << humble[n] << ".";
        else if(n%10==3 && n%100!=13) cout << "The " << n << "rd humble number is " << humble[n] << ".";
        else  cout << "The " << n << "th humble number is " << humble[n] << ".";
        cout << endl;
    }
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
