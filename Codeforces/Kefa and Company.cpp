...
/////////////////////////////////////////////////////////////////////////////////////
ll n,d;
pair<ll,ll> friends[100005];
ll pre[100005];

bool valid(ll start, ll end) {
    return friends[end].F - friends[start].F < d;
}
...
void fast() {
    ...
    for(ll i{1}; i<=n; i++) {
        ...
        while(left < right) {
            ll mid = left + (right-left+1)/2;
            if(valid(i,mid)) left=mid;
            else right=mid-1;
        }
        mx = max(mx, pre[left]-pre[i-1]);
    }
    cout << mx;
}
/////////////////////////////////////////////////////////////////////////////////////
