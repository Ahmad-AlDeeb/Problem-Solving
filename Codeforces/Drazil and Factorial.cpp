...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
vector<ll> primes = sieve(7);
map<ll,ll> primes_exp;
void fast() {
    ll n; cin >> n;
    string s; cin >> s;
    for(auto d:s) {
        ll digit = d-'0';
        for(auto p:primes)
            primes_exp[p] += PP_fact(digit, p);
    }

    string ans;
    map<ll,ll> minus_p;
    for(auto it=primes_exp.rbegin(); it!=primes_exp.rend(); it++) {
