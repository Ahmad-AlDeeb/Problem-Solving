...
void fast() {
    ...
    if(ax >= min(bx,cx) and ax <= max(bx,cx)) {
        if(ay >= min(by,cy) && ay <= max(by,cy)) cout << 1;
        else cout << min(abs(ay-by),abs(ay-cy)) + 1;
    }
    else {
        if(ay >= min(by,cy) && ay <= max(by,cy))
            cout << min(abs(ax-bx),abs(ax-cx)) + 1;
        else
            cout << min(abs(ay-by),abs(ay-cy)) + min(abs(ax-bx),abs(ax-cx)) + 1;
    }
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int main() { IOS
