...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool check(ll num, map<ll,bool> &exist) {
    bitset<32>bs(num);
    string s = bs.to_string();

    for(ll i{31}; i>=0; i--) if(s[i]=='1' && !exist[i]) return false;
    return true;
}
void fast() {
    ll n,x; cin >> n >> x;
    ...
    ll cur{};
    for(auto num:v1) if(check(num,exist)) cur |= num; else break;
    for(auto num:v2) if(check(num,exist)) cur |= num; else break;
    for(auto num:v3) if(check(num,exist)) cur |= num; else break;

    if(cur == x) cout << "YES"; else cout << "NO";
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
int main() { IOS
#ifndef ONLINE_JUDGE
