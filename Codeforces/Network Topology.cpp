...
void fast() {
    ...
    ll size1{},size2{};
    for(auto node:adj) {
        if(node.size()==2) size2++;
        else if(node.size()==1) size1++;
    }
    if(size2 == n-2 && size1== 2) cout << "bus topology";
    else if(size2 == n) cout << "ring topology";
    else if(size1 == n-1) cout << "star topology";
